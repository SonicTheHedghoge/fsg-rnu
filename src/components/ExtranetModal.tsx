...
export default function ExtranetModal({ isOpen, onClose }: ExtranetModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 print:static print:block print:p-0">
      ...
      <div className="absolute inset-0 bg-gray-50 print:hidden overflow-hidden">
        {/* Glow effects */}
        <div className="absolute top-1/2 left-0 w-[800px] h-[800px] bg-blue-300/30 rounded-full blur-[100px] -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute top-1/2 right-0 w-[800px] h-[800px] bg-amber-600/10 rounded-full blur-[100px] translate-x-1/2 -translate-y-1/2"></div>
      ...
      {!isLoggedIn ? (
        <>
          <div className="bg-white shadow-2xl w-full max-w-4xl h-[450px] flex relative z-10 overflow-hidden print:hidden">
            <button onClick={handleClose} className="absolute top-4 right-4 z-20 text-white hover:text-gray-200 bg-black/20 rounded-full p-1 transition-colors">
              <X size={24} />
            </button>
            
            {/* Left side - Login Form */}
            <div 
              className="w-[60%] p-10 flex flex-col justify-center relative z-10 bg-white" 
              style={{ clipPath: 'polygon(0 0, 100% 0, 85% 100%, 0% 100%)' }}
            >
              <h2 className="text-[28px] font-bold text-gray-800 mb-1">Se connecter</h2>
              <p className="text-sm text-[#2b5c8f] mb-8 pr-12 leading-tight">Étudiant / Ancien Étudiant / Enseignant / Administration /<br/>Entreprise</p>
              ...
              <form onSubmit={handleLogin} className="space-y-4 w-[85%]">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm text-gray-700"
                ...
                <div className="border border-gray-300 rounded p-4 flex items-center justify-between bg-[#f9f9f9]">
                  ...
                  <div className="text-[9px] text-gray-500 text-right flex flex-col items-center">
                    <div className="flex items-center gap-1 mb-0.5">
                      <Cloud size={20} className="text-[#f48120] fill-[#f48120]" />
                    </div>
                    <div className="font-bold text-gray-800 tracking-wide text-[10px]">CLOUDFLARE</div>
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <button
                    type="submit"
                    className="flex justify-center items-center gap-2 py-2 px-4 border border-transparent rounded text-sm font-bold text-white bg-[#10b981] hover:bg-[#059669] focus:outline-none transition-colors"
                  >
                    <LogIn size={16} />
                    Se connecter
                  </button>
            ...
            {/* Right side - Image */}
            <div className="absolute right-0 top-0 w-[55%] h-full bg-blue-100">
              <img 
              ...
              {/* Logo Overlay */}
              <div className="absolute inset-0 flex flex-col items-center justify-center pl-16">
                <img src="https://i.imgur.com/zoCEhek.jpeg" alt="FSG Logo" className="w-64 mix-blend-multiply opacity-90" />
              </div>
            </div>
          </div>

          {/* Footer for login page */}
          <div className="absolute bottom-0 left-0 right-0 py-3 bg-[#e6e9ec] border-t border-[#d1d5db] flex items-center justify-between px-8 text-xs text-gray-500 z-10 print:hidden">
            <div className="flex items-center gap-4">
              <div className="w-9 h-6 shrink-0 flex items-center justify-center bg-white rounded-sm border border-gray-300 overflow-hidden shadow-sm">
                <img src="https://i.imgur.com/DdZjx87.png" alt="Drapeau Tunisie" className="w-full h-full object-cover" />
              </div>
            ...
            <div>
              © Copyright 2026 FS GABES. Tous droits réservés.
            </div>
          </div>
        </>
      ) : (
